...
import edu.psu.sagnik.research.vlganalysis.model.{PathStyle, SVGPath, SVGPathCurve}
...
import edu.psu.sagnik.research.vlganalysis.transformparser.model.TransformCommand
